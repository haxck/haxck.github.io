...
这几天 Nano Banana Pro 新发布，效果好到飞起。什么物件分拆解释，人像美颜，就连上次 3D 小人都有了质的改观。刷着刷着看到了一条做表情的 Prompt，试用了一下，瞬间想到了几年前的做套表情的念头，我觉得这个想法可能马上要实现了。
...
接着就可以使用魔法咒语来生成表情了，Prompt 来自 X 上[@Gorden_Sun](https://x.com/Gorden_Sun)。在此基础上加上表情的一些描述，如开心（露出牙齿）、生气（头顶上冒气）的词汇，能更好的把控表情细节。
